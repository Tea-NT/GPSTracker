...
#define WIFI_SCAN_INTERVALL    2
#define WIFI_SCAN_MAX_CNT	   3
...
static void wifi_init_proc(void)
{
	...
	if (util_clock()- s_wifi.clock >= WIFI_SCAN_INTERVALL)
	{
		if (s_wifi.fail_count < WIFI_SCAN_MAX_CNT)
		{
